...
// Local stubs for missing development/build utilities
const sourceMapperPlugin = () => ({ visitor: {} });
const devToolsPlugin = () => ({ name: "dev-tools-stub" });
const fullStoryPlugin = () => ({ name: "fullstory-stub" });
const errorInterceptorPlugin = () => ({ name: "error-interceptor-stub" });
const mediaVersionsPlugin = () => ({ name: "media-versions-stub" });
